...
const scroll = (change: number, ref: RefObject<HTMLInputElement>) => {
...
const PersonList = ({ data }: { data: PersonType[] }): JSX.Element => {
    ...
    <div className="flex flex-col">
      ...
      >
        {data.map((person, index) => (
          <ProfilePicture person={person} key={index} />
        ))}
      </div>
    </div>
  );
